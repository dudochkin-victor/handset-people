...
PersonCommsPage::PersonCommsPage(SeasidePersonModel *pm,
                                 PeopleApplication::CommCat type)
{
    ...
    case PeopleApplication::CatSMS:
        ...
        break;
    case PeopleApplication::CatEmail:
        headerText = headerText.arg("address", "Email");
        m_detailList.append(pm->emails().toList());
        break;

    case PeopleApplication::CatIM:
        headerText = headerText.arg("account", "IM");
        m_detailList.append(pm->ims().toList());
        break;
    }
